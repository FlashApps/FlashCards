    ...
    return {
        ...
        execute: function() {
            HTTPTestService = (function () {
                ...
                HTTPTestService.prototype.getDeck = function () {
                    return this._http.get("http://galvanize-cors-proxy.herokuapp.com/https://api.quizlet.com/2.0/search/sets?client_id=BGDhWP7Cth&whitespace=1&q=spanish&term=silla")
